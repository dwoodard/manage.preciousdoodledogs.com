...
export const timeFromNow = (date, unitOfTime) => {
  if (!date || date === '') {
    return null;
  }
  ...
  // if unit of time is year, return years
  if (unitOfTime === 'year') {
    return `${years} ${year}`;
  }
  ...
  if (unitOfTime === 'week') {
    const weeks = Math.floor(today.getTime() / (1000 * 60 * 60 * 24 * 7))
      - Math.floor(birthDate.getTime() / (1000 * 60 * 60 * 24 * 7));
  ...
  if (unitOfTime === 'day') {
    const days = Math.floor(today.getTime() / (1000 * 60 * 60 * 24))
      - Math.floor(birthDate.getTime() / (1000 * 60 * 60 * 24));
  ...
  if (unitOfTime === 'hour') {
    const hours = Math.floor(today.getTime() / (1000 * 60 * 60))
      - Math.floor(birthDate.getTime() / (1000 * 60 * 60));
