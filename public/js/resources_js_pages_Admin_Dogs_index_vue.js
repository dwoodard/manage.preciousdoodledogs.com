...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    traitOptionsByCategory: function traitOptionsByCategory() {
      var traitOptionsByCategory = [];
      this.trait_options.forEach(function (trait) {
        var category = trait.category;
        var traitOptions = traitOptionsByCategory.find(function (traitOptions) {
          return traitOptions.category === category;
        });
  ...
  methods: {
    ...
    allelesList: function allelesList(traitOption) {
  ...
  mounted: function mounted() {
    ...
    // eslint-disable-next-line promise/always-return
    axios__WEBPACK_IMPORTED_MODULE_0___default().get('/admin/trait-options').then(function (response) {
      _this2.trait_options = response.data;
    });
  }
});
    ...
    [
      ...
      _c(
        ...
        [
                    ...
                    "v-form",
                    {
                      on: {
                        submit: function ($event) {
                          ...
                          return _vm.addHeatSubmit.apply(null, arguments)
                        },
                      },
                    },
                    [
                              ...
                              directives: [
                                {
                                  name: "model",
                                  rawName: "v-model",
                                  value: _vm.newHeat.heat_at,
                                  expression: "newHeat.heat_at",
                                },
                              ],
                              attrs: { type: "date", required: "" },
                              domProps: { value: _vm.newHeat.heat_at },
                              on: {
                                input: function ($event) {
                                  if ($event.target.composing) {
                                    return
          ...
          _c("v-container", [
            _c("span", [
              _c("b", [
                _vm._v(
                  "Next Est Heat (" +
                    _vm._s(_vm.toOrdinal(_vm.dogHeats.length + 1)) +
                    "):"
                ),
              ]),
              _vm._v(
                "\n        " +
                  _vm._s(_vm.dog.heats.next_est_heat_date) +
                  " ( " +
                  _vm._s(
                    _vm.moment(_vm.dog.heats.next_est_heat_date).fromNow()
                  ) +
                  ")\n      "
              ),
            ]),
          ...
          _c(
            "v-container",
            _vm._l(_vm.dogHeats, function (heat, index) {
              return _c(
                "form",
                {
                  key: index,
                      ...
                      _c(
                        ...
                        [
                          _c("v-col", { attrs: { cols: "2" } }, [
                            _vm._v(
                              _vm._s(
                                _vm.toOrdinal(_vm.dogHeats.length - index)
                              ) + " Heat"
                            ),
                          ]),
                          _vm._v(" "),
                              ...
                              directives: [
                                {
                                  ...
                                  rawName: "v-model",
                                  value: heat.heat_at,
                                  expression: "heat.heat_at",
                                },
                              ],
                              attrs: { type: "date" },
                              domProps: { value: heat.heat_at },
                              on: {
                                change: function ($event) {
                                  return _vm.update(heat)
                                },
                                input: function ($event) {
                                  ...
                                  _vm.$set(heat, "heat_at", $event.target.value)
                                },
                              },
                            }),
                          ]),
            ...
            [
              ...
              _c(
                ...
                [
                  _c(
                    "v-container",
                    _vm._l(_vm.traitOptionsByCategory, function (group, index) {
                      return _c(
                        "v-card",
                        ...
                        [
                          ...
                          _c(
                            "v-card-text",
                            _vm._l(group.traits, function (trait, j) {
                              return _c("v-select", {
                                key: j,
                                staticClass: "mt-0",
                                attrs: {
                                  items: _vm.allelesList(trait),
                                  clearable: true,
                                  label: trait.trait,
                                  "item-text": "name",
                                  "item-value": "id",
                                ...
                                model: {
                                  ...
                                  callback: function ($$v) {
                                    _vm.$set(_vm.form, trait.code, $$v)
                                  },
                                  expression: "form[trait.code]",
                                },
                              })
                            }),
                            1
              ...
              _c("v-data-table", {
                ...
                attrs: {
                  ...
                  headers: [
                    ...
                    {
                      text: "Next Est Heat",
                      value: "heats.next_est_heat_date",
                    },
                    {
                      text: "Next Est Xray",
